...
var addToHome = function(e) {
    ...
    function E() {
        ...
        y.touchIcon && (n = i ? "/games.softgames.de/assets/images/touch-icon-iphone-retina.png": "/games.softgames.de/assets/images/touch-icon-iphone.png", n ? n = '<span style="background-image:url(' + n + ')" class="addToHomeTouchIcon"></span>': n = ""),
...
function() {
    ...
    Softgames.prototype._apiUrl = function(e, t) {
        ...
        "/" + this.host + e + "?" + this._queryString(t)
    },
    ...
    Softgames.prototype._init = function(e) {
        ...
        this.openx_host = "/ads.softgames.de/www/delivery/",
        this._getUrlParameters().host ? this.kirk_host = "//" + unescape(this._getUrlParameters().host) + "/api/": this.kirk_host = "/m.softgames.de/api/",
        this.system_id = this._getSystemId(),
        this.game_slug = this._getGameSlug(),
        this.defaultBackUrl = "/m.softgames.de/",
