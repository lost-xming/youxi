...
fg_api.prototype.adsModule = function() {
	...
	module.prototype.showClick2PlayOverlay = function(callback, force) {
		...
		M.playBtnContainer = self.createElement("div", {
			"class": "fg-click2play" + (M.show_initial ? " fg-click2play-continue" : "")
		});
		...
		M.playBtn = self.createElement("div", {
			"class": "btn-play",
			"title": (M.adcount > 0 ? "Continue" : "Play now")
		});
		...
		M.playBtnContainer.appendChild(M.gameIcon);
		M.playBtnContainer.appendChild(M.playBtn);
		...
		if (!M.show_initial && detection.is.pc) {
			...
			M.playBtnContainer.style.opacity = 1;
		}
	};
...
/* /updates.html5rocks.com/2014/07/Web-Audio-Changes-in-m36 */
...
fg_api.prototype.handleClick = function(element, callback){
	...
	if(typeof callback === 'function'){
		// /stackoverflow.com/questions/13396297/windows-phone-8-touch-support
...
fg_api.prototype.screenshotModule = function() {
	...
	function displayScreenshotOverlay(imageSrc) {
		...
		M.fgSaveScreenshot.innerHTML = '<svg version="1.1" xmlns="/www.w3.org/2000/svg" xmlns:xlink="/www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve"><polygon id="check-mark-icon" points="398.218,92.985 199.729,291.475 113.754,205.476 50,269.242 199.733,419.015 462,156.726 "/></svg>';
		...
		fgDiscardScreenshot.innerHTML = '<svg version="1.1" xmlns="/www.w3.org/2000/svg" xmlns:xlink="/www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve"><polygon id="x-mark-icon" points="438.393,374.595 319.757,255.977 438.378,137.348 374.595,73.607 255.995,192.225 137.375,73.622 73.607,137.352 192.246,255.983 73.622,374.625 137.352,438.393 256.002,319.734 374.652,438.378 "/></svg>';
...
fg_api.prototype.moreGamesLink = function(popup) {
	...
	if (!moreGamesLink || moreGamesLink == "/" || moreGamesLink == "javascript:") {
		return false;
	}
			...
			M.callbackFn = function() {
				if(swfobject.getFlashPlayerVersion().major === 0) {
					...
					fgGetFlashLink = self.createElement("a", {
						"href": "/www.adobe.com/go/getflashplayer",
						"target": "_blank"
					});
