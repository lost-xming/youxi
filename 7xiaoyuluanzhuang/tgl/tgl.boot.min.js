...
!function (a, b) {
	...
	function l(a) {
		a = a || B;
		for (var b in a)
			if (a.hasOwnProperty(b) && a[b].state !== I)
				return !1;
		return !0
	}
	function m(a) {
		a.state = G,
		d(a.onpreload, function (a) {
			a.call()
		})
	}
	function n(a) {
	...
	function o() {
		...
		e = c[0];
		return f(b) || (b = null),
		g(a[0]) ? (a[0].push(b), E.load.apply(null, a[0]), E) : (e ? (d(c, function (a) {
					!f(a) && a && n(k(a))
	...
	function p() {
		...
		c = {};
		return f(b) || (b = null),
		g(a[0]) ? (a[0].push(b), E.load.apply(null, a[0]), E) : (d(a, function (a) {
		...
		function g() {
			if (b.state !== I && b.cssRetries <= 20) {
				for (var c = 0, d = y.styleSheets.length; d > c; c++)
					if (y.styleSheets[c].href === h.href)
						return void f({
							type : "load"
						});
				b.cssRetries++,
	...
	function t() {
		for (var a = y.getElementsByTagName("script"), b = 0, c = a.length; c > b; b++) {
			...
			if (d)
				return void E.load(d)
		}
	}
	function u(a, b) {
		if (a === y)
			return x ? i(b) : z.push(b), E;
		...
		if ("string" != typeof a || !f(b))
			return E;
		var e = B[a];
		if (e && e.state === I || "ALL" === a && l() && x)
			return i(b), E;
		var h = A[a];
	...
	if ("complete" === y.readyState)
		...
		y.addEventListener("DOMContentLoaded", w, !1), a.addEventListener("load", v, !1);
	else {
...
(window), function () {
	head.js("js/GameConfig.js", function () {
		if ("undefined" == typeof GameConfig)
			return void alert("FATAL ERROR: Unable to locate GameConfig");
		var a;
