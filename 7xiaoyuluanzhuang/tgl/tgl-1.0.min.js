...
var TGL = TGL || {}, _qevents = _qevents || [], _loadStartTime = (new Date).getTime();
TGL.Debug = TGL.Debug || {}, TGL.Debug.LOG_NONE = 0, TGL.Debug.LOG_ERROR = 1, TGL.Debug.LOG_WARNING = 2, TGL.Debug.LOG_INFO = 3, TGL.Debug.LOG_VERBOSE = 4, TGL.Debug.LogLevel = TGL.Debug.LOG_INFO, TGL.Debug.Log = function (a) {
	...
	if (this._sConfig = a, "number" == typeof a.LOG_LEVEL && (TGL.Debug.LogLevel = a.LOG_LEVEL), TGL.Debug.Log(TGL.Debug.LOG_INFO, "TreSensa TGL GameLoader started"), a.DEBUG = "undefined" != typeof a.DEBUG ? a.DEBUG : !1, a.DEBUG && TGL.Debug.Log(TGL.Debug.LOG_WARNING, "Debug mode enabled"), a.hasOwnProperty("LIB_DIR") && TGL.Debug.Log(TGL.Debug.LOG_WARNING, "GameConfig.LIB_DIR in use. Local copies of the TreSensa libraries will be used."), a.NATIVE_APP = !("undefined" == typeof CordovaConfig), a.TIZEN_APP = !("undefined" == typeof TizenConfig), a.NATIVE_APP && TGL.Debug.Log(TGL.Debug.LOG_INFO, "Native app detected"), a.TIZEN_APP && TGL.Debug.Log(TGL.Debug.LOG_INFO, "Tizen app detected"), a.hasOwnProperty("TGE") ? a.TGE.ENABLED = "undefined" != typeof a.TGE.ENABLED ? a.TGE.ENABLED : !0 : a.TGE = {
		...
		return void TGL.Debug.Log(TGL.Debug.LOG_ERROR, "GameConfig.TITLE, VERSION, TGL.VERSION, TGE.VERSION, TGS.VERSION, and CONSTRUCTOR are required properties and must be defined. Stopping game load!");
	if (a.TGE.ENABLED) {
		var b = function () {
			navigator.userAgent.match(/(iPhone|iPod touch);.*CPU.*OS 7_.*Safari/i) || document.addEventListener("touchmove", function (a) {
				a.preventDefault()
			}, !1)
		};
	...
	if (a.hasOwnProperty("GoogleAnalytics") ? a.GoogleAnalytics.ENABLED = "undefined" != typeof a.GoogleAnalytics.ENABLED ? a.GoogleAnalytics.ENABLED : !0 : a.GoogleAnalytics = {
		...
		if (a.GoogleAnalytics.ENABLED && ("undefined" === CordovaConfig.GoogleAnalytics.NATIVE_ID || "" == CordovaConfig.GoogleAnalytics.NATIVE_ID))
			return void TGL.Debug.Log(TGL.Debug.LOG_ERROR, "CordovaConfig.GoogleAnalytics.NATIVE_ID is required for native app builds. Stopping game load!");
	...
	!a.NATIVE_APP && a.GoogleAnalytics.ENABLED && (!function (a, b, c, d, e, f, g) {
		...
		(window, document, "script", "", "_gaTreSensa"), TGL.Debug.Log(TGL.Debug.LOG_INFO, "Google Analytics loaded")),
	a.TGE.FONT_LOADER && (TGL.Debug.Log(TGL.Debug.LOG_VERBOSE, "Font loader enabled"), a.NATIVE_APP && navigator.userAgent.match("iPhone|iPad") ? window.Font = function () {}

		 : c.push(TGL.SDKBaseURL + "tge/3rdparty/font" + TGL.MinifiedSuffix + ".js")),
	...
	head.ready(function () {
		...
		var b = {
			phaser : ["/sdk.tresensa.com/plugins/phaser/tgshelper.js"]
		},
		c = (a.ENGINE || "TGE").toLowerCase();
		b[c] ? head.load(b[c], TGL.setEventListeners) : TGL.setEventListeners()
	})
}, TGL.setEventListeners = function () {
	if (GameConfig.NATIVE_APP || !GameConfig.GoogleAnalytics.ENABLED || GameConfig.GoogleAnalytics.STUDIO_ONLY || (_gaTreSensa("create", GameConfig.PROD_ENV ? "UA-29301358-66" : "UA-29301358-8", "auto", {
				name : "TGLTracker"
	...
	!TGL.RanGame && GameConfig.ADS.PRELOADER_PLACEMENT_ID && TGS.Advertisement._DisplayPreloaderAd({
	...
	if (TGL.Debug.Log(TGL.Debug.LOG_VERBOSE, "initializeTGE called"), TGL.RanGame)
		return void TGL.Debug.Log(TGL.Debug.LOG_VERBOSE, "Leaving Early/Duplicate call");
	...
	if ("undefined" != typeof CordovaConfig)
		return CordovaConfig.hasOwnProperty("DST_ID") ? CordovaConfig.DST_ID : null;
	if ("undefined" != typeof TizenConfig)
		return TizenConfig.hasOwnProperty("DST_ID") ? TizenConfig.DST_ID : null;
	...
	a || b && "NA" != b && "A0000" != b || (a = "/www.mobilewebarcade.com"),
	a
